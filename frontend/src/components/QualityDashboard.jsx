...
const QualityDashboard = ({ repo, latestReview, onRefresh, onFileSelect, isHistoryView, workspaceStatus, workspaceInfo, remainingSeconds, formattedTime, onRestoreComplete, onCleaned }) => {
  ...
  if (!repo) {
    return (
      <div className="flex-1 p-4 md:p-8 bg-[#0a0a0a] flex flex-col gap-6 animate-pulse">
        <div className="h-48 bg-gray-900 rounded-2xl w-full" />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"><div className="h-32 bg-gray-900 rounded-2xl" /><div className="h-32 bg-gray-900 rounded-2xl" /><div className="h-32 bg-gray-900 rounded-2xl" /><div className="h-32 bg-gray-900 rounded-2xl" /></div>
      </div>
    );
  }
