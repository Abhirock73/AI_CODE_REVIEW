...
const FileViewer = ({ repoId, repo, selectedFile, isHistoryView, onCodeChange, onReRunReview, latestReview, workspaceStatus, onRestoreComplete }) => {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-gray-950">
      ...
      {/* TOP TOOLBAR */}
      <div className="flex-none bg-gray-900 border-b border-gray-800 px-4 py-2 flex items-center justify-between gap-3 overflow-x-auto">
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-xl w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-800 flex items-center justify-between">
              <div className="flex items-center gap-2 text-white font-bold text-base">
                ...
                <span>Review Version History</span>
              </div>
              <button
      ...
      {showInactivityModal && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-yellow-500/50 rounded-xl w-full max-w-lg shadow-2xl overflow-hidden">
